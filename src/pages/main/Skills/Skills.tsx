        ...
        <div className='z-10 bg-white w-full relative h-auto flex flex-col items-start justify-start'
            ...
            <main className=' w-full h-auto z-10 flex justify-between bg-white'>
                <div className='w-1/3 h-full sticky'>
                    <motion.img src={clouds} className="sticky top-20 h-[100vh] w-full"
                        initial={{ y: 0 }}
                    />
                    <motion.img src={fale} className="sticky top-20 h-[100vh] w-full"
                        initial={{ y: 0 }}
                    />
                    <motion.img src={blocks} className="sticky top-20 h-[100vh] w-full"
                        initial={{ y: 0 }}
                    />
                </div>
