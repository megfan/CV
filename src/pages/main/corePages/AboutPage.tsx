    ...
    return (
        <div
            ...
            <div className='z-10 flex flex-col text-darkPrimary lg:-ml-20 mt-10 lg:col-start-4 col-start-2 col-end-6 lg:row-start-2 row-start-1 text-sm '>
                ...
                <h1 className='lg:text-4xl text-2xl font-bold mb-12 mt-6 relative tittle'>My creative
                    <span className='text-primary lg:text-5xl text-4xl font-[Titillium] lowercase italic'> evolution </span></h1>
                ...
                <button className='py-4 px-6 lg:block hidden buttonMovingRight mt-10 uppercase font-bold text-white tracking-wider text-xs bg-primary w-fit'>photography / soon</button>
            </div>
            <motion.p
