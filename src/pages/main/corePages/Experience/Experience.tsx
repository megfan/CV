...
export const Experience: React.FC = () => {
    ...
    const others = experienceData.find(e => e.order === 8);


    return (<>
        <div className='gridPage w-full h-auto relative m-0 p-0 overflow-hidden' id="experience" ref={ref}>
            {/* {isDesktop ? ( */}
            <div className='bg-white h-auto flex flex-col w-full lg:pt-40 lg:pr-20 col-start-2 col-end-7 row-start-1 row-end-8'>
                ...
                <div className='z-10 w-full lg:mt-20'>
                    ...
                    <div className='flex flex-col text-gray-600 text-2xl items-start justify-start w-full mt-15 lg:pr-30 relative h-auto'>
                        ...
                        <div className='flex lg:flex-row flex-col w-full lg:ml-40 lg:mt-30 mt-10'>
                    ...
                    <div className='flex  text-gray-600 text-xl items-start justify-start w-full lg:my-40 my-20 h-auto'>
                        <div className='bg-lightGray lg:p-12 p-4 flex lg:w-1/3 lg:mr-10 relative'>
                            ...
                            <button className='absolute -right-20 top-16 hover:translate-x-12 duration-300'>
